...
import { Loader2, ShoppingBag, User as UserIcon, Mail, Phone, Home, CreditCard, ArrowLeft } from 'lucide-react';
...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // Proceed to payment step instead of directly placing order
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center space-x-4">
            <div className={`flex items-center space-x-2 ${currentStep === 'shipping' ? 'text-amber-500' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep === 'shipping' ? 'bg-amber-500 text-gray-900' : 'bg-gray-600'}`}>
                1
              </div>
              <span>Shipping</span>
            </div>
            <div className="w-8 h-0.5 bg-gray-600"></div>
            <div className={`flex items-center space-x-2 ${currentStep === 'payment' ? 'text-amber-500' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep === 'payment' ? 'bg-amber-500 text-gray-900' : 'bg-gray-600'}`}>
                2
              </div>
              <span>Payment</span>
            </div>
