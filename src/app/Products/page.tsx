      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
          ...
          <main className="flex-1">
            ...
            {isLoading ? (
              <div className="flex justify-center items-center h-80"><Loader2 className="animate-spin text-amber-500" size={48} /></div>
            ) : error ? ( 
              <div className="text-center py-12 px-8 bg-red-900/50 rounded-xl"><ServerCrash size={60} className="mx-auto text-red-300 mb-5" /><p>{error}</p></div>
            ) : (
              <ProductGrid 
                items={filteredItems} 
                selectedCategory={selectedCategory} 
