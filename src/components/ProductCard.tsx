...
const ModernProductCard = ({ item, index, onAddToCart }: ModernProductCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col bg-black/30 backdrop-blur-lg border border-slate-700/50 rounded-xl shadow-lg overflow-hidden transition-all duration-300 ease-out hover:shadow-xl hover:shadow-black/40 hover:ring-1 hover:ring-amber-500/60"
    >
